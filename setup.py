...
setup(
    ...
    version='2.01',      # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/rawsashimi1604/stockscrape_v2/archive/refs/tags/v2.01.tar.gz',
